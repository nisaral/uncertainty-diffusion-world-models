...
| File | What it is |
|---|---|
| [`RESEARCH_OVERVIEW.md`](RESEARCH_OVERVIEW.md) | One-page statement of the question, metrics, and limits |
| [`PAPER_DRAFT.md`](PAPER_DRAFT.md) | Working draft of that same claim (not submission-ready) |
| [`LITERATURE_SURVEY.md`](LITERATURE_SURVEY.md) | Living survey |
